<template>
  ...
  <div class="card">
     ...
     <button @click="wizard2.wand.core = 'Pheonix feather'">
        Change wand core
      </button>
...
watch(
  ...
  (newValue, oldValue) => {
    console.log('Watch an array of ref(primitive value), a property of ref(pirimitive value), a property of a ref(object), and a ref(object)')
  },
  {deep: true})
</script>
